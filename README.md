...
- **Measured, not argued.** 11 faults × 6 systems, every cell regenerated by `python3 experiments/run_all.py` in under a second. CI fails if the tables drift from the code.
