...
- **Tested against ourselves.** 273 tests including a 2,000-case randomized fault sweep. Writing them found 15 real bugs in our own gate; each fix has a test that failed before it.
