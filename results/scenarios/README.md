# Scenario results: Interlock against a standard setup and a fair hand-written check

Same content as `docs/10-scenarios.md`; per-scenario files are next to this README.
